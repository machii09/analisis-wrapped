...
for line in lines:
    line = line.replace('\u202f', ' ').replace('\u200e', '')  # limpiar caracteres invisibles
...
# 3. Nube de palabras (tradicional para matplotlib)
...
# --------- NUBE DE PALABRAS INTERACTIVA (PLOTLY) ---------
